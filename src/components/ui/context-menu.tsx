...
>(({ className, inset, ...props }, ref) => (
	<ContextMenuPrimitive.Item
		ref={ref}
		className={cn(
			"relative flex gap-2.5 cursor-default select-none items-center rounded-sm px-4 py-2.5 text-sm bg-background-default text-foreground-default hover:bg-background-active hover:text-foreground-active outline-none focus:bg-slate-100 focus:text-slate-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-slate-800 dark:focus:text-slate-50",
			inset && "pl-8",
			className,
		)}
		{...props}
